...
.size_small_7[
（参考）<br>
ログアウト処理を行うと、mobile backend 上の会員データも更新されます。updateDate フィールドの値がログアウト処理を実行した時刻になっていることを確認してみましょう。
]
]
.right-column[
.center[<img src="readme-img/動作確認①ログアウト.png" alt="動作確認①ログアウト" width="300px">]
...
.size_small_7[
（参考）<br>
ログイン処理も同様に、mobile backend 上の会員データも更新されます。updateDate フィールドの値がログアウト処理を実行した時刻になっていることを確認してみましょう。
]
]
.right-column[
